...
const char *ssid = "Quad_Hover";
const char *password = "quadhover";
...
void webSocketEvent(uint8_t num, WStype_t type, uint8_t * payload, size_t length) {
  ...
  */            }
                ...
                if(payload[0]=='h' && payload[1]=='o' && payload[2]=='v' && payload[3]=='e' && payload[4]=='r') {
                ...
                if(payload[0]=='c' && payload[1]=='o' && payload[2]=='p' && payload[3]=='t' && payload[4]=='e' && payload[4]=='r') {
                  digitalWrite(relayPin, LOW);
